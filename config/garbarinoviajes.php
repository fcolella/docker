...
if (is_readable( __dir__.'/environment/'.getenv('APP_ENV').'.php' ))
{
	include __dir__.'/environment/'.getenv('APP_ENV').'.php';
	$config = array_replace_recursive($config, ${getenv('APP_ENV')});
}
return $config;